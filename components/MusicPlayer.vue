<template>
  <div class="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-gray-900 to-black border-t border-gray-800 p-4">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4 w-1/3">
        <div class="relative group">
          <img 
            ...
            class="w-14 h-14 rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105"
          />
          <div v-else class="w-14 h-14 bg-gray-800 rounded-lg flex items-center justify-center">
      ...
      <div class="flex flex-col items-center w-1/3">
        <div class="flex items-center space-x-6 mb-2">
          ...
          <button @click="togglePlay" class="bg-white text-black rounded-full p-3 hover:scale-110 transition-all duration-300 shadow-lg">
